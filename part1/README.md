...
## ✍️ 5. Review Submission – Sequence Diagram

This diagram shows how a user submits a new review or retrieves an existing one.
...
This diagram shows how a client requests a list of places with optional filters.
